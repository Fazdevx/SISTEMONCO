...
export default function Dashboard() {
  ...
  if (loading) return (
    <div className="flex h-[80vh] items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-medium animate-pulse">Cargando estadísticas...</p>
      </div>
    </div>
  );
  ...
  const monthlyData = {
    ...
    datasets: [{
      ...
      backgroundColor: getComputedStyle(document.documentElement).getPropertyValue('--accent-soft'),
      fill: true,
      tension: 0.4,
      pointRadius: 4,
  ...
  const biradsData = {
    ...
    datasets: [{
      ...
      backgroundColor: [
        '#94a3b8', '#10b981', '#f59e0b', '#f97316', '#ef4444', '#881337'
      ],
      borderWidth: 0,
    }]
  };
    ...
    <div className="space-y-8 p-6  max-w-7xl mx-auto">
      <header className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Resumen general del sistema de tamizaje oncológico</p>
        </div>
